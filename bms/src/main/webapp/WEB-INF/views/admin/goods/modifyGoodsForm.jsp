...
<body>
	...
	<div align="right">
		<input type="button" value="상품 삭제하기" class="btn btn-outline-danger btn-sm" onclick="location.href='${contextPath}/admin/goods/removeGoodsInfo.do?goodsId=${goods.goodsId }'">
	</div>
</body>
</html>