...
<script>
	...
	$().ready(function(){
		...
		$("#goodsPrice").blur(function(){
			$("#goodsSalesPrice").prop("value" , $("#goodsPrice").prop("value") * 0.9);
		});
	...
	function fn_add_new_goods(obj){
		...
		var title = document.addgoodsform.goodsTitle;
		var writer = document.addgoodsform.goodsWriter;
		var publisher = document.addgoodsform.goodsPublisher;
		var price = document.addgoodsform.goodsPrice;
		var salesPrice = document.addgoodsform.goodsSalesPrice;
		var point = document.addgoodsform.goodsPoint;
		var totalPage = document.addgoodsform.goodsTotalPage;
		var isbn = document.addgoodsform.goodsIsbn;
		var deliveryPrice = document.addgoodsform.goodsDeliveryPrice;
		...
		if (salesPrice.value == ""){
			alert("제품 판매가격을 작성해주세요");
			salesPrice.focus();
			return false;	
		}
		
		if (point.value == "") {
			alert("제품 구매 포인트를 작성해주세요");
			point.focus();
			return false;
		}
		
		if (totalPage.value == "") {
			alert("제품 총 페이지수를 작성해주세요");
			totalPage.focus();
			return false;
		}
...
<body>
	<form action="${contextPath}/admin/goods/addNewGoods.do" method="post" name="addgoodsform" enctype="multipart/form-data">
		<h1>새상품 등록창</h1>
			...
			<div class="tab_container">
				<div class="tab_content" id="tab1">
					<table class="table table-bordered table-hover">			
						...
						<tr>
							<td>제품 판매가격</td>
							<td><input name="goodsSalesPrice" id="goodsSalesPrice" placeholder="정가의 10% 할인" type="text" class="form-control"/></td>
						</tr>
						<tr>
							<td>제품 구매 포인트</td>
