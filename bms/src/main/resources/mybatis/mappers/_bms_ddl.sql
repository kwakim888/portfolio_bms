...
DROP TABLE T_SHOPPING_GOODS CASCADE CONSTRAINTS;
DROP TABLE T_SHOPPING_NOTICE;
DROP TABLE T_SHOPPING_MEMBER CASCADE CONSTRAINTS;
...
CREATE TABLE T_SHOPPING_NOTICE(
	...
	NOTICE_READ_COUNT	NUMBER(20),
	CONSTRAINT NOTICE_PK_NOTICE_NUM PRIMARY KEY (NOTICE_NUM),
	CONSTRAINT NOTICE_FK_MEMBER_ID FOREIGN KEY (MEMBER_ID)
	REFERENCES T_SHOPPING_MEMBER (MEMBER_ID)
);
...
CREATE TABLE T_SHOPPING_CART(
    ...
    MEMBER_ID               VARCHAR2(20),
    GOODS_ID                NUMBER(20),
    ORDER_GOODS_QTY          NUMBER(4),
    GOODS_TITLE             VARCHAR2(100),
    GOODS_SALES_PRICE       NUMBER(10),
    GOODS_DELIVERY_PRICE    NUMBER(5),
    GOODS_FILE_NAME         VARCHAR2(50),
    CREDATE                 DATE,
